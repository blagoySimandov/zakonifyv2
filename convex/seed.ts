    ...
    const attorneys = [
      {
        ...
        hourlyRate: 350,
        location: { city: 'Sofia', state: 'Sofia City', country: 'Bulgaria' },
        isVerified: true,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        hourlyRate: 450,
        location: { city: 'Plovdiv', state: 'Plovdiv', country: 'Bulgaria' },
        isVerified: true,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        location: { city: 'Varna', state: 'Varna', country: 'Bulgaria' },
        isVerified: true,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        hourlyRate: 400,
        location: { city: 'Burgas', state: 'Burgas', country: 'Bulgaria' },
        isVerified: true,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        hourlyRate: 325,
        location: { city: 'Stara Zagora', state: 'Stara Zagora', country: 'Bulgaria' },
        isVerified: true,
        createdAt: now,
        updatedAt: now,
      },
