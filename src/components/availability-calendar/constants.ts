export const CALENDAR_CONSTANTS = {
  ...
  TRY_DIFFERENT_DATES: 'Try selecting different dates or adjust your preferences',
  ...
  BOOKING_MODAL: {
    ...
    NOTES_PLACEHOLDER: 'Please provide any additional information about your legal matter...',
