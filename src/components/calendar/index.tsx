...
export function Calendar({ consultations, onConsultationClick }: CalendarProps) {
  const scriptLoaded = useRef(false);
  const [expandedConsultations, setExpandedConsultations] = useState<Set<string>>(new Set());
  const [selectedConsultation, setSelectedConsultation] = useState<ConsultationWithMatter | null>(null);
  ...
  const handleViewDetails = (consultation: ConsultationWithMatter, e: React.MouseEvent) => {
    e.stopPropagation();
  ...
  const handleJoinVideoCall = (consultation: ConsultationWithMatter, e: React.MouseEvent) => {
    e.stopPropagation();
            ...
            {consultations.length === 0 ? (
              ...
              <div className="flex-1 overflow-y-auto space-y-3">
                {consultations.map((consultation) => {
                  const startDateTime = formatDateForAddEvent(consultation.scheduledAt);
                  const endTime = formatEndTime(consultation.scheduledAt, consultation.duration);
                  
                  const isExpanded = expandedConsultations.has(String(consultation._id));
                    ...
                    >
                      ...
                      <div className="p-4 sm:p-3">
                        ...
                        <div
                          ...
                          onClick={() => toggleExpanded(String(consultation._id))}
                        >
                        ...
                        <div className={`overflow-hidden transition-all duration-300 ${
                          ...
                          <div className="pt-3 border-t border-slate-200/50 mt-3 space-y-3">
                            ...
                            <div className="flex items-start gap-2 text-xs">
                              ...
                              <div>
                                <div className="text-slate-600 font-medium">Client Information</div>
                                <div className="text-slate-500">Contact details will be available here</div>
                              </div>
                            </div>
                            ...
                            {consultation.notes && (
                              <div className="flex items-start gap-2 text-xs">
                                ...
                                <div>
                                  ...
                                  <div className="text-slate-500">{consultation.notes}</div>
                                </div>
                              </div>
                            )}
                            ...
                            <div className="flex flex-col gap-2 pt-2">
                              ...
                              <div className="flex flex-col sm:flex-row gap-2">
                                <button
                                  onClick={(e) => handleViewDetails(consultation, e)}
                                ...
                                <button
                                  onClick={(e) => handleJoinVideoCall(consultation, e)}
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <span className="title">Legal Consultation</span>
                                  <span className="description">
                                    Legal consultation - Duration: {consultation.duration} minutes. 
