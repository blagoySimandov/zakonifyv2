...
interface CreditCardFormProps {
  ...
  onFieldChange: <K extends keyof PaymentInfo>(field: K, value: PaymentInfo[K]) => void;
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              placeholder={BOOKING_MESSAGES.PAYMENT_STEP.PLACEHOLDERS.EXPIRY_DATE}
              maxLength={5}
            />
        ...
        <div>
          ...
          <input
            ...
            placeholder={BOOKING_MESSAGES.PAYMENT_STEP.PLACEHOLDERS.CARDHOLDER_NAME}
          />
