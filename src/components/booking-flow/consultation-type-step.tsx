    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="grid gap-4">
          {(
            Object.keys(
              BOOKING_CONSTANTS.CONSULTATION_TYPE_STEP.TYPES,
            ) as ConsultationType[]
          ).map((type) => {
            const typeData =
              BOOKING_CONSTANTS.CONSULTATION_TYPE_STEP.TYPES[type];
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mb-3">{typeData.description}</p>
