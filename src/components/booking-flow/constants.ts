export const BOOKING_CONSTANTS = {
  ...
  CONSULTATION_TYPE_STEP: {
    ...
    TYPES: {
      video: {
        ...
        features: ['Screen sharing', 'Recording available', 'Secure & encrypted'],
      },
      phone: {
        title: 'Phone Call',
        description: 'Traditional phone consultation',
        features: ['No video required', 'Works with any phone', 'High quality audio'],
      },
      'in-person': {
        title: 'In-Person Meeting',
        description: 'Meet at the attorney\'s office',
        features: ['Face-to-face discussion', 'Document review', 'Personal attention'],
      },
    },
  },
  ...
  CLIENT_INFO_STEP: {
    ...
    FIELDS: {
      ...
      CONSULTATION_TOPIC_PLACEHOLDER: 'Brief description of your legal matter...',
      ADDITIONAL_NOTES: 'Additional Notes (Optional)',
      ADDITIONAL_NOTES_PLACEHOLDER: 'Any additional information that might be helpful...',
      PRIVACY_CONSENT: 'I consent to the collection and use of my personal information',
  ...
  CONFIRMATION_STEP: {
    ...
    CANCELLATION_POLICY: 'You can cancel or reschedule up to 24 hours before your consultation',
  },
