export const DASHBOARD_CONSTANTS = {
  ...
  ERROR: {
    ...
    GENERIC_MESSAGE: 'There was an error loading your availability dashboard. Please try again.',
  ...
  WELCOME: {
    ...
    MESSAGE: 'Start by setting up your working hours and consultation preferences to allow clients to book appointments with you.',
  ...
  CONFIRMATION: {
    ...
    GO_OFFLINE_MESSAGE: 'Clients will not be able to book new consultations while you are offline.',
    CANCEL_CONSULTATION_TITLE: 'Cancel Consultation?',
    CANCEL_CONSULTATION_MESSAGE: 'This action cannot be undone. The client will be notified.',
    CONFIRM: 'Confirm',
    CANCEL: 'Cancel',
  },
