    ...
    return (
      <div className="flex flex-wrap gap-2">
        {stats.leastBookedDays.map((day) => (
          ...
          >
            {DASHBOARD_CONSTANTS.DAY_SHORT_NAMES[day as keyof typeof DASHBOARD_CONSTANTS.DAY_SHORT_NAMES]}
          </span>
        ))}
      </div>
    );
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900">
          {DASHBOARD_CONSTANTS.AVAILABILITY_STATS.TITLE}
        </h3>
      </div>
      ...
      {stats ? (
        <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-gray-700">Weekly Utilization</span>
              <span className={`px-2 py-1 rounded-full text-xs font-medium ${getUtilizationColor(stats.utilizationRate)}`}>
            ...
            <p className="text-xs text-gray-500 mt-1">{stats.utilizationRate}% of available time booked</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              ...
              <p className="text-lg font-bold text-blue-700">{stats.totalHoursPerWeek}h</p>
            ...
            <div className="text-center p-3 bg-green-50 rounded-lg">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <span className="text-sm font-medium text-green-900">Avg Slots</span>
              </div>
              <p className="text-lg font-bold text-green-700">{stats.averageSlotsPerDay}</p>
          ...
          <div>
            <h4 className="font-medium text-gray-900 mb-3 flex items-center gap-2">
              ...
              {DASHBOARD_CONSTANTS.AVAILABILITY_STATS.PEAK_HOURS}
            </h4>
            {renderPeakHours()}
          </div>
          ...
          <div>
            <h4 className="font-medium text-gray-900 mb-3">
              {DASHBOARD_CONSTANTS.AVAILABILITY_STATS.LEAST_BOOKED_DAYS}
            </h4>
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 text-sm">
            {DASHBOARD_CONSTANTS.AVAILABILITY_STATS.NO_DATA}
          </p>
