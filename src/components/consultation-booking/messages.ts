export const BOOKING_MESSAGES = {
  SUCCESS: {
    ...
    CONFIRMATION: 'The attorney will confirm your appointment and send you further details.',
  ...
  INFO: {
    ...
    CONSULTATION_DISCLAIMER: 'This booking is subject to attorney availability and confirmation.',
