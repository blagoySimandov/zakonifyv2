...
export const AttorneyRegistrationSchema = z.object({
  ...
  bio: z.string()
    .min(50, 'Bio must be at least 50 characters to help clients understand your expertise')
    .max(1000, 'Bio must be less than 1000 characters')
    .optional(),
  
  // Practice Areas
  practiceAreas: z.array(z.enum(PRACTICE_AREAS as [string, ...string[]]))
  ...
  fixedFeePackages: z.array(z.object({
    name: z.string()
...
export type AttorneyRegistrationFormData = z.infer<typeof AttorneyRegistrationSchema>
