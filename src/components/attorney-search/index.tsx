  ...
  const renderSearchHeader = () => (
    <div className="bg-white shadow-sm border-b sticky top-0 z-40">
      <div className="max-w-6xl mx-auto px-6 py-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Find Legal Counsel</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              {areFiltersVisible ? SEARCH_CONSTANTS.ACTIONS.HIDE_FILTERS : SEARCH_CONSTANTS.ACTIONS.SHOW_FILTERS}
        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('practiceAreas', e.target.value === 'all' ? undefined : [e.target.value])}
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                >
                  <option value="">{SEARCH_CONSTANTS.PLACEHOLDERS.STATE}</option>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('experienceLevel', e.target.value === 'all' ? undefined : e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('rateRange', e.target.value === 'all' ? undefined : e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('selectedLanguages', e.target.value === 'all' ? undefined : [e.target.value])}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('availability', e.target.value === 'all' ? undefined : e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('rating', e.target.value === 'all' ? undefined : e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateFilter('consultationType', e.target.value === 'all' ? undefined : e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-sm font-medium text-gray-700">Verified attorneys only</span>
            </label>
          </div>
        </div>
      </div>
        ...
        <>
          <div className="flex items-center justify-between mb-6">
            <div className="text-sm text-gray-600">
              {SEARCH_CONSTANTS.RESULTS.SHOWING} <span className="font-semibold text-gray-900">{attorneys.length}</span> {SEARCH_CONSTANTS.RESULTS.OF} <span className="font-semibold text-gray-900">{attorneys.length}</span> {SEARCH_CONSTANTS.RESULTS.ATTORNEYS}
            </div>
          </div>
          ...
          {attorneys.length === 0 ? (
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">{SEARCH_CONSTANTS.RESULTS.NO_RESULTS}</h3>
                <p className="text-gray-500 mb-6">{SEARCH_CONSTANTS.RESULTS.TRY_DIFFERENT}</p>
                {hasActiveFilters && (
                  <button
                    onClick={clearAllFilters}
